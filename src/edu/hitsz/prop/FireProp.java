...
public class FireProp extends AbstractProp {
    ...
    private static final int EFFECT_DURATION = 10000; // 10 秒
    ...
    public void activate(HeroAircraft hero) {
        ...
        System.out.println("FireSupply active! 散射弹道已启用，10 秒后自动恢复");
    ...
    private static class RestoreTask implements Runnable {
        ...
        public void run() {
            try {
                ...
                System.out.println("FireSupply expired! 已恢复直射弹道");
